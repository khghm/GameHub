// server/src/main/kotlin/com/gamehub/server/GameJson.kt
...
// Serializer برای Instant (تبدیل به میلی‌ثانیه)
...
val serverGameJson = Json {
    ...
    serializersModule = SerializersModule {
        ...
        // ثبت serializerهای سفارشی برای UUID و Instant
        contextual(UUIDSerializer)
        contextual(InstantSerializer)
        // PlayerId نیز نیاز به serializer دارد
...
object PlayerIdSerializer : KSerializer<PlayerId> {
    ...
    override fun serialize(encoder: Encoder, value: PlayerId) = encoder.encodeString(value.value)
    override fun deserialize(decoder: Decoder): PlayerId = PlayerId(decoder.decodeString())
}